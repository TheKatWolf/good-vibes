...
*Built by Kat Wolfe and Jennifer Watters of Team Good-Vibes for the 2026 GenAI Academy Global Hackathon.*
...
Add the above Environment Variables into the Vercel project settings.

Click "Deploy". Vercel will automatically build the Next.js frontend and provide a live URL.
